...
init()
{
	level.SOlID_SURVIVAL_VERSION = "1.0";
	...
	if ( getDvar( "bots_manage_add" ) == "" )
		setDvar( "bots_manage_add", 0 ); //amount of bots to add to the game ///////USE THIS FOR SPAWNING

	if ( getDvar( "bots_manage_fill" ) == "" )
		setDvar( "bots_manage_fill", 0 ); //amount of bots to maintain

	if ( getDvar( "bots_manage_fill_spec" ) == "" )
		setDvar( "bots_manage_fill_spec", false ); //to count for fill if player is on spec team
	...
	if ( getDvar( "bots_team" ) == "" )
		setDvar( "bots_team", "axis" ); //which team for bots to join /////////////////EDIT THIS///////////////autoassign is def

    //not used when bots_team_force is true
	if ( getDvar( "bots_team_amount" ) == "" )
		setDvar( "bots_team_amount", 8 ); //amount of bots on axis team  ///////////////////PUT THIS TO 8////////////////

	if ( getDvar( "bots_team_force" ) == "" )//force team was false
		setDvar( "bots_team_force", true ); //force bots on team

	if ( getDvar( "bots_team_mode" ) == "" )//was 0
		setDvar( "bots_team_mode", 1 ); //counts just bots when 1

	if ( getDvar( "bots_skill" ) == "" )
		setDvar( "bots_skill", 1 ); //0 is random, 1 is easy 7 is hard, 8 is custom, 9 is completely random      ///////////////USE THIS FOR HIGH ROUNDS
	...
	if ( getDvar( "bots_loadout_reasonable" ) == "" ) //filter out the bad 'guns' and perks
		setDvar( "bots_loadout_reasonable", true );
	...
	if ( getDvar( "bots_play_camp" ) == "" ) //bots camp and follow
		setDvar( "bots_play_camp", false );

	if ( getDvar( "bots_play_jumpdrop" ) == "" ) //bots jump and dropshot
		setDvar( "bots_play_jumpdrop", false );
	...
	level.bots_fullautoguns = [];    //use this to edit loadouts in round
	level.bots_fullautoguns["fmg9"] = false;
	level.bots_fullautoguns["skorpion"] = false;
	level.bots_fullautoguns["mp9"] = false;
	level.bots_fullautoguns["g18"] = false;
	level.bots_fullautoguns["mp5"] = true;
	level.bots_fullautoguns["m9"] = false;
	level.bots_fullautoguns["p90"] = false;
	level.bots_fullautoguns["pp90m1"] = false;
	level.bots_fullautoguns["ump45"] = false;
	level.bots_fullautoguns["mp7"] = false;
	level.bots_fullautoguns["ak47"] = true;
	level.bots_fullautoguns["m4"] = false;
	level.bots_fullautoguns["fad"] = true;
	level.bots_fullautoguns["acr"] = true;
	level.bots_fullautoguns["scar"] = false;
	level.bots_fullautoguns["g36c"] = false;
	level.bots_fullautoguns["cm901"] = false;
	level.bots_fullautoguns["aa12"] = false;
	level.bots_fullautoguns["m60"] = false;
	level.bots_fullautoguns["mk46"] = false;
	level.bots_fullautoguns["pecheneg"] = false;
	level.bots_fullautoguns["sa80"] = false;
	level.bots_fullautoguns["mg36"] = false;

	level.bots_fullautoguns["ak74u"] = false;
